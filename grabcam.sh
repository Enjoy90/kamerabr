...
echo " "
sleep 1
printf "      \e[1;77m v1.0 Tools hack kamera android V1.2\e[0m \n"
sleep 1
printf "          \e[1;77m v1.1 This reborn script by { Mr.beee30 }\e[0m \n"

printf "\n"
sleep 1
echo "      N073:> Nyalakan Hotspot anda untuk mengakses link yang telah tersedia"
